...
// Complete item map for ALL 40 TIERS
const BP_ITEMS = {
  1:  { name: 'Iron Ore', type: 'material', rarity: 'common', desc: '⚒️ Basic crafting ore' },
  2:  { name: 'Monster Fang', type: 'material', rarity: 'common', desc: '🦴 Common monster crafting material' },
  3:  { name: 'Silver Ore', type: 'material', rarity: 'uncommon', desc: '⚒️ Refined crafting ore' },
...
function getBPTierRewards(t) {
  ...
  const stoneAmt = t * 20;
  const item = BP_ITEMS[t] || { name: 'Iron Ore', type: 'material', rarity: 'common', desc: '⚒️ Basic crafting ore' };
  ...
  str += ` | 🎁 *${item.name}* (${item.rarity.toUpperCase()})`;
