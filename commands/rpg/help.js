...
const KNOWN_SUBCOMMANDS = {
  ...
  guild: ['create', 'join', 'leave', 'list', 'info', 'members', 'promote', 'upgrade', 'shop', 'deposit', 'withdraw', 'hire', 'accept', 'decline', 'disband', 'war', 'vault', 'icon', 'bio', 'rename'],
  store: ['E', 'D', 'C', 'B', 'A', 'S', 'info', 'buy'],
  armory: ['E', 'D', 'C', 'B', 'A', 'S', 'info', 'buy'],
  joingc: ['--silent'],
  ...
  party: ['create', 'status', 'ready', 'raid', 'join', 'advance', 'boss', 'heal', 'revive', 'leave', 'kick'],
...
module.exports = {
  ...
  async execute(sock, msg, args, getDatabase, saveDatabase, sender) {
    ...
    const menuLines = [
      ...
      ``,
      `🔧 *PROGRESSION & GEAR:*`,
      `  /store (/armory) — daily weapons & gear (the ONLY source), /inv <#> · /equip <#> · /equip gift <#> @p, /class, /awaken, /attacks, /summon, /craft, /forge, /enchant, /upgrade, /pet, /artifact, /aura, /constellation, /skin, /title`,
      ``,
      `🏰 *GUILD & ECONOMY:*`,
